...
namespace FunctionApp6
{
    ...
    public static class Function4
    {
        ...
        const string ServiceBusConnectionString = "Endpoint=sb://pg-dev-di-sbus01.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=ScCYRfMnmQtNBmOln2Q1f/omy/YbSdCDhUe1kg6BUOs=";
        const string QueueName = "datasync";
        const string QueueNameDeadletter = "datasync/$deadletterqueue";
        static IQueueClient queueClient;
        static IQueueClient deadLetterQueueClient;
        const int MaximumDeliveryCount = 100;
